...
describe('getIssueLabels function', () => {
  ...
  test('should not add labels inside the comments section', () => {
    const body = 'Body with labels: Label1  <!-- the label Label2 is mentioned in the body, but its commented and shouldn`t be tracked -->';
    const labels = ['Label1', 'Label2'];
  ...
  test('should check if there is any synonym for the labels available', () => {
    const body = 'Body with labels: Synonym1  <!-- the label Synonym2 is mentioned in the body, but its commented and shouldn`t be tracked -->';
    const labels = ['Label1', 'Label2'];
